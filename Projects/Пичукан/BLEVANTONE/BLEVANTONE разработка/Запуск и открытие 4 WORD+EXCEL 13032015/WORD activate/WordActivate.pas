...
var
  Form1: TForm1;
  WRD,Book,BookPicture,wdInlineShapes: OleVariant;
...
begin
 ...
 function DIRFileDetect: string;    //определяется директория папки без названия файла
 ...
 // *****************************************************************
 //функция ищет в ВОРДЕ заданный текст по всему документу и дает на него ссылка объект range
...
begin
 ...
 // WRD.Selection.Find.Text:='***';
  ...
  //MyRange2.Font.Color := RGB(255, 100, 100);
    ...
    MyRange2.Paste;
   // ShowMessage('Рис НОРМ '+inttostr(j));
    j:= j+1;
   until ReplaceText [j]  = '';
