...
begin
 ...
 begin
    ...
    begin
    ShowMessage('ћайкрософт Ёксел не установлен на данном компютере');
     result:=False;
    end;
 end;
...
begin
 { if ExistExcel then
                ShowMessage('Ёксель установлен на данном компьютере')
                else
                ShowMessage('Ёксель отсутствует на данном компьютере');
   if RunExcel then
                ShowMessage('Ёксель запущен на данном компьютере')
                else
                ShowMessage('Ёксель не запущен на данном компьютере');
   RunExcel;  }

   if StartExcel then
   begin
    ShowMessage('ѕроцесс запущен');
   end;
